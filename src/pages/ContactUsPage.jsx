                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-3 col-sm-6 card bg-primary p-4 mb-5 border-5 border-light">
                            ...
                            <Link to="mailto:vishankchauhan@gmail.com" target='blank' rel="noreferrer" className='text-light text-center'>ashish@gmail.com</Link>
                        </div>
                        <div className="col-md-3 col-sm-6 card bg-primary p-4 mb-5 border-5 border-light">
                            <h3 className='text-light text-center'><i className='fa fa-phone'></i> Phone</h3>
                            <Link to="tel:+919873848046" target='blank' rel="noreferrer" className='text-light text-center'>+91-3983298398</Link>
                        </div>
                        <div className="col-md-3 col-sm-6 card bg-primary p-4 mb-5 border-5 border-light">
                            <h3 className='text-light text-center'><i className='fa fa-whatsapp'></i> Whats App</h3>
                            <Link to="https://wa.me/+919873848046" target='blank' rel="noreferrer" className='text-light text-center'>+91-3298328938</Link>
                        </div>
                    </div>
