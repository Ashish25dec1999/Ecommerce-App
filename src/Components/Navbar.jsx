        ...
        <div className="row gx-0 d-none d-lg-flex">
          <div className="col-lg-7 px-5 text-start">
            <div className="h-100 d-inline-flex align-items-center py-3 me-4">
              ...
              <Link to="mailto:vishankchauhan@gmail.com" target='_blank' rel='noreferrer'>ashish@gmail.com</Link>
            </div>
            <div className="h-100 d-inline-flex align-items-center py-3 me-4">
              <small className="fa fa-phone text-primary me-2"></small>
              <Link to="tel:+919873848046" target='_blank' rel='noreferrer'>+91-3289298333</Link>
            </div>
            <div className="h-100 d-inline-flex align-items-center py-3 me-4">
              <small className="fa fa-whatsapp text-primary me-2"></small>
              <Link to="https://wa.me/+919873848046" target='_blank' rel='noreferrer'>+91-3289329838</Link>
            </div>
          </div>
