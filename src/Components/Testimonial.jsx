            ...
            <div className="container-xxl py-2">
                <div className="container">
                    ...
                    <div className=" wow fadeInUp" data-wow-delay="0.1s">
                        <Swiper modules={[Autoplay, Pagination, Navigation]} loop={options.loop} autoplay={{ delay: options.autoplayTimeout, disableOnInteraction: false, }} navigation={true} pagination={{ clickable: true }}>
                            {
                                data?.map((item) => {
                                    return <SwiperSlide key={item.id} className="testimonial-item text-center">
