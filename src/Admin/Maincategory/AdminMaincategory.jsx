...
// //                              This code will work without redux also
// // import React, { useEffect, useState } from "react";

// // import $ from 'jquery'  //import jQuery
// // import 'datatables.net-dt/css/dataTables.dataTables.min.css'; //import dataTable styles
// // import 'datatables.net'
...
// //                     </div>
// //                     <div className="col-md-9">
// //                         <h5 className="bg-primary text-light text-center p-2">Maincategory <Link to='/admin/maincategory/create'><i className="fa fa-plus text-light float-end"></i></Link>
// //                         </h5>
// //                         <table className='table table-bordered table-hover table-striped' id="DataTable">
// //                             <thead>
// //                                 <tr>
...
// //                                                 <td>
// //                                                     <Link to={`${process.env.REACT_APP_SERVER}${item.pic}`} target="_blank" rel="noreferrer">
// //                                                         <img src={`${process.env.REACT_APP_SERVER}${item.pic}`} height={50} width={80} className="rounded" alt="Maincategory Image/Not found" />
// //                                                     </Link>
// //                                                 </td>
// //                                                 <td>{item.active ? "Yes" : "No"}</td>
// //                                                 <td><Link to={`/admin/maincategory/update/${item.id}`} className="btn btn-primary"><i className="fa fa-edit"></i></Link></td>
